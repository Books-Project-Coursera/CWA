...
of a single model. Because the rule consumes only one scalar per checkpoint, it
transfers across tasks unchanged: we instantiate it with validation loss for
classification and with validation fitness for detection and segmentation.
