...
already computes, keep the top $k$, average them. Because all it needs is an
ordering of the checkpoints, the same procedure applies to classification,
detection and segmentation unchanged.
