...
python main.py train --exp-name carparts_compare_run01 --methods top-k ema swa
```
...
python main.py train --exp-name carparts_swa_const --methods swa   --swa-lr-schedule extend --swa-extra-budget 0.25 --patience 0
```
...
sheet `DeltaVsBaseline`. Run `--swa-lr-schedule extend` báo cáo thành bảng
